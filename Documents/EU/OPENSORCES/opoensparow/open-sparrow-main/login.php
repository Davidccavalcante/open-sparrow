...
<body>
    ...
    const eyeClosed = '<svg width="20" height="20" '
        + 'viewBox="0 0 24 24" fill="none" stroke="#888" '
        + 'stroke-width="2" stroke-linecap="round" '
        + 'stroke-linejoin="round">'
        + '<path d="M17.94 17.94A10.07 10.07 0 0 1 12 '
        + '20c-7 0-11-8-11-8a18.45 18.45 0 0 1 '
        + '5.06-5.94"/>'
        + '<path d="M9.9 4.24A9.12 9.12 0 0 1 12 '
        + '4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 '
        + '3.19"/>'
        + '<path d="M14.12 14.12a3 3 0 1 '
        + '1-4.24-4.24"/>'
